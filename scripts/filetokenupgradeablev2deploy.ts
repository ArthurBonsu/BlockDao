...
let  { DeployFunction }  =require  ("hardhat-deploy/types");
...
await deploy('FileTokenUpgradeableV2', { // this will create a deployment called 'Token'. By default it will look for an artifact with the same name. the contract option allows you to use a different artifact
from: deployer,
...
UpgradeFunc.tags = ['FileTokenUpgradeableV2'];